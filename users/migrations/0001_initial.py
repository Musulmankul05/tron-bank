# Generated by Django 5.2 on 2026-07-04 10:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kyc_status', models.CharField(choices=[('PEN', 'Pending'), ('UNV', 'Unverified'), ('VER', 'Verified'), ('REJ', 'Rejected')], default='UNV', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('STANDART', 'Private node'), ('BUSINESS', 'Corporate node')], default='STANDART')),
