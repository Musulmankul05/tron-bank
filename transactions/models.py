...
class TransactionModel(models.Model):
    ...
    sender = models.ForeignKey(CardModel, on_delete=models.CASCADE, related_name='sent')
    receiver = models.ForeignKey(CardModel, on_delete=models.CASCADE, related_name='received')
    ...
    fee = models.DecimalField(decimal_places=4, max_digits=14, blank=True, null=True)
